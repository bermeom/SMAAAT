 ...
 * @author berme_000
 */
public class AgentExplorer extends AgentBESA{

    public AgentExplorer(String alias, StateBESA state, StructBESA structAgent, double passwd) throws KernellAgentExceptionBESA {
